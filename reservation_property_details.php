 ...
 * --------------------------------------------------------------------
 * Reservation Property Details Page (reservation_property_details.php)
 **********************************************************************/
...
{
    $arrBookingData = $_SESSION['booking_data'];
} else {
 ...
 ************************************/
$strPageName = 'reservation_property_details';
        ...
        <div class="row">
            ...
            <div class="theiaStickySidebar">
            	<div class="box_style_1">
                    ...
                    {
                    ?>
                    <form id="check_available" name="check_avail" action="<?php echo BASE_URL_RSB?>property-details/<?php echo $property->id?>/<?php echo generateSEOURL($property->property_name)?>/" method="post" role="form">
                        <input type="hidden" id="redirect_url" name="redirect_url" value="<?php echo BASE_URL_RSB?>property-details/<?php echo $property->id?>/<?php echo generateSEOURL($property->property_name)?>/" />
                    	...
                    	<div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="dates_booking" name="dates_booking" value="<?php echo ((isset($arrBookingData['dates_booking']))?($arrBookingData['dates_booking']):(''))?>" placeholder="Requested Dates" />
                        	...
                        	<div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <label>Adults</label>
                            	   <div class="qty-buttons">
                                        ...
                                        <input type="text" id="adults" name="adults" class="qty form-control" value="<?php echo ((isset($arrBookingData['adults']))?($arrBookingData['adults']):(''))?>" placeholder="0" />
                    ...
                    ?>
                    <a href="javascript:void(0);" class="btn_outline">Contact Us</a>
