 ...
 * -------------------------------------------------------
 * Square Helper Functions (helper_functions.php)
 *********************************************************/
...
{
  $_SESSION['checkout_data'] = $currOrder;
 ...
 ******************************************************************************/
function getCheckoutId($currOrder=array())
{
  if (isset($_SESSION['checkout_id']) && $_SESSION['checkout_id'] != '')
  {
...
function getOrderTotal($currOrder)
{
    if (!empty($currOrder))
    {
      $orderTotal = $_SESSION['checkout_data']['order']['line_items'][0]['base_price_money']['amount'];
    } else {
      $orderTotal = 0;
    }
    return $orderTotal;
 ...
 ******************************************************************************/
function verifyTransaction($getResponse, $apiResponse, $savedCheckoutId, $savedOrderTotal)
{
