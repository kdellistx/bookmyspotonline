 ...
 * ---------------------------------------------------
 * Add Item Page (add_marketplace_item.php)
 *****************************************************/
 ...
 ************************************/
$strPageName = 'add_marketplace_item';
$strPageTitle = 'Sell An Item';
    ...
    <div class="container margin_60">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="job-details-wrapper">
                            <h3>Add Listing Details</h3>
                            <p>Hey, <?php echo $user->first_name?>, fill out the form below to list an item in the marketplace. You can use the menu at the right to make changes to your account, such as update your information, change your password, or perform other tasks.</p>
                            <form id="frmAddMarketplace" name="frmAddMarketplace" action="<?php echo BASE_URL_RSB?>my-account/" method="post" class="form-light mt-20" enctype="multipart/form-data" role="form">
                                <input id="action" name="action" type="hidden" value="add_marketplace_item" />
                ...
                <!-- END: Marketplace Item Description -->
