 ...
 * -------------------------------------------------------
 * Square Charge Script (generate_charge.php)
 *********************************************************/
...
try {
  ...
  saveCheckoutId($arrOrder, $checkoutID);
} catch (Exception $e) {
...
showDebug($_SESSION['checkout_id'], 'checkout id', false);
showDebug($_SESSION['checkout_data'], 'checkout data array', false);

showDebug($_SESSION['checkout_data']['order']['line_items'][0]['base_price_money']['amount'], 'order data array', false);

$intOrderTotal = getOrderTotal($_SESSION['checkout_data']['order']);
showDebug($intOrderTotal, 'order total', false);
