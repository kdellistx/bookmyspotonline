...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL_RSB?>css/base.css" />
    <script src="<?php echo BASE_URL_RSB?>js/jquery-3.3.1.min.js"></script>
    <?php
      if ($strPageName == 'home' || $strPageName == 'trip_planner' || $strPageName == 'marketplace_map' || $strPageName == 'marketplace_item_details')
      {
        ?>
        <script src="<?php echo BASE_URL_RSB?>js/jquery.geolocation.js"></script>
        <?php
      }
      ?>
    <!--[if lt IE 9]>
    ...
    <![endif]-->
    <script type='text/javascript' src='//platform-api.sharethis.com/js/sharethis.js#property=5b81fdd3de278e00111a438b&product=sticky-share-buttons' async='async'></script>
  </head>
  <body>
    <div class="layer"></div>
    <div id="preloader">
